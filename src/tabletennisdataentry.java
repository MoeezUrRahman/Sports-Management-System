...
public class tabletennisdataentry extends JFrame implements ActionListener {
...
//        time.setText("Enter Data here: ");
        ...
        title.setText("Student Data Entry");
        ...
        if(e.getSource()==login){
            ...
            if(a.isEmpty() || b.isEmpty() || c.isEmpty() || d.isEmpty() || f.isEmpty()){
                ...
                try {
                    ...
                    dbHandler.modifyRecord("TableTennis",f,b,d,a,f);
                } catch (InterruptedException ex) {
                    throw new RuntimeException(ex);
                }
            JOptionPane.showMessageDialog(null," Record has been submitted.");
            this.dispose();}
        }
    }
}
